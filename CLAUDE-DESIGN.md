...
- Available skills (57): tdd, debug, design, verify, review-response, strategy-evolution, security-scan, refactor, docs, perf, api-design, migrate, team-implement, team-review, team-review-periodic, scqa, content-repurpose, tone-enforce, summarize, copywriting, video-script, diagram, infographic, flowchart, ui-layout, source-validate, competitive-intel, deep-research, knowledge-structure, video-edit, caption-format, code-review-ext, devops, workflow-auto, skill-creator, premise-check, ideate, retro-metrics, release-gate, auto-decide, threat-model, post-mortem, prioritize, estimate, test-strategy, observability, a11y, data-model, onboard, present, negotiate, impact-analysis, runbook-creation, compliance-check, contract-testing, structural-isolation, confidence-calibration
