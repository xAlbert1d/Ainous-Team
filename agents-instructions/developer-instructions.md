...
2. Read your **playbook**: `~/.claude/ainous-roles/developer/playbook.md` (evolved strategies)
3. Read **project context**: `.claude/ainous-roles/developer/journal.md` and `memory.md` (if exist)
4. Read **team knowledge**: `~/.claude/ainous-roles/team-knowledge.md` and `.claude/ainous-roles/team-knowledge.md`
5. Initialize: `mkdir -p .claude/ainous-roles/developer .claude/ainous-roles/developer/traces .claude/ainous-roles/team-sync/state .claude/ainous-roles/team-sync/artifacts`
6. Set role marker: `echo "developer" > ~/.claude/.session-role || exit 1`
